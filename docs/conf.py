...
version = 'version = release = '0.1.1''
# The full version, including alpha/beta/rc tags
release = version

extlinks = {
    'issue': ('https://github.com/janLuke/spotipie/issues/%s', '#'),
    'pr': ('https://github.com/janLuke/spotipie/pull/%s', 'PR #'),
}
...
man_pages = [
    (master_doc, 'spotipie', 'spotipie Documentation',
     [author], 1)
]
